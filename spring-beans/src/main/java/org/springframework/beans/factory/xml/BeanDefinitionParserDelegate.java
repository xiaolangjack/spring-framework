...
/**
 * Stateful delegate class used to parse XML bean definitions.用于解析 XML bean 定义的有状态委托类
 * Intended for use by both the main parser and any extension 供主解析器和任何扩展使用
